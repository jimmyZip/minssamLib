...
<ol>
	<li><a href="#" onClick="location.href='#'">권한 관리 </a></li>
	<li><a href="#" onClick="location.href='#'">맴버 관리</a></li>
	<li><a href="#" onClick="location.href='#'">리뷰 관리</a></li>
	<li><a href="#" onClick="location.href='#'">리뷰 코멘트 관리</a></li>
	<li><a href="#" onClick="location.href='#'">도서 코멘트 관리</a></li>
</ol>	    
</div>
